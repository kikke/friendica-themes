...
<input id="twittersub" type="submit" value="$sub" class="settings-submit" name="perihel-settings-sub"></input>
</div>
</form>
</div>
...
<div class="settings-submit-wrapper">
<input id="mapsub" type="submit" value="$sub" class="settings-submit" name="perihel-settings-map-sub"></input>
</div>
...
<div class="settings-submit-wrapper">
<input id="boxsub" type="submit" value="$sub" class="settings-submit" name="perihel-settings-box-sub"></input>
</div>
</fieldset>
</form>
</div>
...
<a href="$url/facebook"><img alt="Facebook" src="view/theme/perihel/icons/facebook.png" title="Facebook"></a>
<a href="$url/settings/connectors"><img alt="StatusNet" src="view/theme/perihel/icons/StatusNet.png?" title="StatusNet"></a>
<a href="$url/settings/connectors"><img alt="LiveJournal" src="view/theme/perihel/icons/livejournal.png?" title="LiveJournal"></a>
<a href="$url/settings/connectors"><img alt="Posterous" src="view/theme/perihel/icons/posterous.png?" title="Posterous"></a>
<a href="$url/settings/connectors"><img alt="Tumblr" src="view/theme/perihel/icons/tumblr.png?" title="Tumblr"></a>
<a href="$url/settings/connectors"><img alt="Twitter" src="view/theme/perihel/icons/twitter.png?" title="Twitter"></a>
<a href="$url/settings/connectors"><img alt="WordPress" src="view/theme/perihel/icons/wordpress.png?" title="WordPress"></a>
<a href="$url/settings/connectors"><img alt="E-Mail" src="view/theme/perihel/icons/email.png?" title="E-Mail"></a>
</div>
{{ endif }}
</div>

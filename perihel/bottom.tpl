<script type="text/javascript" src="$baseurl/view/theme/perihel/js/jquery.autogrow.textarea.js"></script>
...
$(document).ready(function() {
	...
	$(window).scroll(function () { 
      ...
      $("a#down").attr("onclick","scrolldown()");
	 	$("img#scroll_top_bottom").attr("src","view/theme/perihelbook/icons/scroll_bottom.png");
      ...
      $("a#top").attr("onclick","scrolltop()");
	 	$("img#scroll_top_bottom").attr("src","view/theme/perihelbook/icons/scroll_top.png");

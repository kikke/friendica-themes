...
/*
 * Name: Neptuned
 * Description: Frost with some additions
...
function neptuned_init(&$a) {
	...
	if( $a->module === 'home' || $a->module === 'login' || $a->module === 'register' || $a->module === 'lostpass' ) {
		$a->page['htmlhead'] = str_replace('$stylesheet', $a->get_baseurl() . '/view/theme/neptuned/login-style.css', $a->page['htmlhead']);
	}
	if( $a->module === 'login' )
